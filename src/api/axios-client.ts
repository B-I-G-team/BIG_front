...
export class Client {
    ...
    constructor(baseUrl?: string, instance?: AxiosInstance) {
        ...
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "/big";
     ...
     * @return Default Response
     */
    current(offset: string | null | undefined, limit: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous3> {
        let url_ = this.baseUrl + "/bookings/current?";
    ...
    protected processCurrent(response: AxiosResponse): Promise<Anonymous3> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    gymPOST(body: Body2 | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous4> {
    ...
    protected processGymPOST(response: AxiosResponse): Promise<Anonymous4> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            return Promise.resolve<Anonymous4>(result201);
     ...
     * @return Default Response
     */
    gymGET(offset: string | null | undefined, limit: string | null | undefined, search: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous5> {
        let url_ = this.baseUrl + "/gym?";
        if (offset !== undefined && offset !== null)
            url_ += "offset=" + encodeURIComponent("" + offset) + "&";
        if (limit !== undefined && limit !== null)
    ...
    protected processGymGET(response: AxiosResponse): Promise<Anonymous5> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    gymGET2(gymID: string , cancelToken?: CancelToken | undefined): Promise<Anonymous6> {
    ...
    protected processGymGET2(response: AxiosResponse): Promise<Anonymous6> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    teamsPOST(body: Body3 | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous8> {
    ...
    protected processTeamsPOST(response: AxiosResponse): Promise<Anonymous8> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    teamsGET(offset: string | null | undefined, limit: string | null | undefined, search: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous9> {
        let url_ = this.baseUrl + "/teams?";
        if (offset !== undefined && offset !== null)
            url_ += "offset=" + encodeURIComponent("" + offset) + "&";
        if (limit !== undefined && limit !== null)
    ...
    protected processTeamsGET(response: AxiosResponse): Promise<Anonymous9> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    presigned(extension: string | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous10> {
    ...
    protected processPresigned(response: AxiosResponse): Promise<Anonymous10> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 201) {
            ...
            let result201: any = null;
            let resultData201  = _responseText;
            result201 = Anonymous10.fromJS(resultData201);
            return Promise.resolve<Anonymous10>(result201);
     ...
     * @return Default Response
     */
    meGET(  cancelToken?: CancelToken | undefined): Promise<Anonymous11> {
    ...
    protected processMeGET(response: AxiosResponse): Promise<Anonymous11> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Default Response
     */
    mePUT(body: Body4 | null | undefined , cancelToken?: CancelToken | undefined): Promise<Anonymous12> {
        let url_ = this.baseUrl + "/users/me";
          url_ = url_.replace(/[?&]$/, "");
    ...
    protected processMePUT(response: AxiosResponse): Promise<Anonymous12> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(Data3.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }
...
export class Data implements IData {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.createdAt = _data["createdAt"] ? new Date(_data["createdAt"].toString()) : <any>undefined;
            this.updatedAt = _data["updatedAt"] ? new Date(_data["updatedAt"].toString()) : <any>undefined;
            this.gym = _data["gym"] ? Gym.fromJS(_data["gym"]) : new Gym();
            if (Array.isArray(_data["teamBooking"])) {
                this.teamBooking = [] as any;
                for (let item of _data["teamBooking"])
                    this.teamBooking!.push(TeamBooking.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.teamBooking)) {
            data["teamBooking"] = [];
            for (let item of this.teamBooking)
                data["teamBooking"].push(item.toJSON());
        }
        return data;
    }
}
...
export class Status3 implements IStatus3 {

    constructor(data?: IStatus3) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Status3 {
        data = typeof data === 'object' ? data : {};
        let result = new Status3();
        result.init(data);
        return result;
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["images"])) {
                this.images = [] as any;
                for (let item of _data["images"])
                    this.images!.push(Images4.fromJS(item));
            }
        }
    }

    static fromJS(data: any): Gym {
        data = typeof data === 'object' ? data : {};
        let result = new Gym();
        result.init(data);
        return result;
...
export class TeamBooking implements ITeamBooking {
    id!: string;
    team!: Team3;

    constructor(data?: ITeamBooking) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.team = _data["team"] ? Team3.fromJS(_data["team"]) : new Team3();
        }
    }

    static fromJS(data: any): TeamBooking {
        data = typeof data === 'object' ? data : {};
        let result = new TeamBooking();
        result.init(data);
        return result;
    }
...
export class Images4 implements IImages4 {
    id!: string;
    url!: string;
    createdAt!: Date;

    constructor(data?: IImages4) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Images4 {
        data = typeof data === 'object' ? data : {};
        let result = new Images4();
        result.init(data);
        return result;
    }
...
export interface IImages4 {
    id: string;
    url: string;
    createdAt: Date;
}

export class Team3 implements ITeam3 {
    id!: string;
    name!: string;
    image?: string | undefined;
    introduction!: string;
    ...
    static fromJS(data: any): Team3 {
        data = typeof data === 'object' ? data : {};
        let result = new Team3();
        result.init(data);
        return result;
    }
...
export function initPersister() {
  ...
  addResultTypeFactory('Client___current', (data: any) => { const result = new Anonymous3(); result.init(data); return result; });
  addResultTypeFactory('Client___gymGET', (data: any) => { const result = new Anonymous5(); result.init(data); return result; });
  addResultTypeFactory('Client___gymGET2', (data: any) => { const result = new Anonymous6(); result.init(data); return result; });
  addResultTypeFactory('Client___teamsGET', (data: any) => { const result = new Anonymous9(); result.init(data); return result; });
  addResultTypeFactory('Client___presigned', (data: any) => { const result = new Anonymous10(); result.init(data); return result; });
  addResultTypeFactory('Client___meGET', (data: any) => { const result = new Anonymous11(); result.init(data); return result; });
